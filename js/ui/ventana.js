function Ventana(){
	...
	this.createEnvironment = function(){
		...
		document.getElementById('divAhorcado').style.display = 'block';
	...
	this.displayLostFilm = function() {
		...
		resultUser.innerHTML = "Perdiste";
		resultUser.style.backgroundColor = 'red';
	...
	this.displayWinnerFilm = function() {
		...
		resultUser.innerHTML = "Ganaste";
		resultUser.style.backgroundColor = 'green';
		resultUser.style.display = 'block';
	};
	...
	this.addPista = function(pista){
		document.getElementById('listaPistas').innerHTML += '<li>' + pista.key + ": " + pista.value + '</li>';
	};
